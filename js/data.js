const DataManager = {
    init() {
        if (!localStorage.getItem('dora_courses')) {
            localStorage.setItem('dora_courses', JSON.stringify([
                { id: 1, title: 'Corporate Finance Essentials', description: 'Master the fundamentals of financial management and investment analysis.', instructor: 'Dr. Sarah Wilson', videoUrl: 'https://www.youtube.com/embed/fA-mC17x07o' },
                { id: 2, title: 'Strategic Business Leadership', description: 'Advanced strategies for managing teams and driving organizational growth.', instructor: 'Marcus Chen', videoUrl: 'https://www.youtube.com/embed/W6NZfCO5SIk' }
            ]));
        }
